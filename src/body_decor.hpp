...
public:
    ...
    bool canDrawLandscape() {return drawLandscape; }
    //! indique si on est dans des conditions permettant de tracer les météors
    bool canDrawMeteor() {return drawMeteor;}
    //! indique si on est dans des conditions permettant de tracer l'atmosphère
    // bool canDrawAtmosphere() {return drawAtmosphere;}
    //! indique si on est dans des conditions permettant de tracer la représentation 3D du Body
    bool canDrawBody() {return drawBody;}
    ...
    void bodyAssign(double altitude, const AtmosphereParams* atmParam);
