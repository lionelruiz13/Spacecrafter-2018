...
bool Illuminate::createIlluminate(std::string filename, double ra, double de, double angular_size, string name, double r, double g, double b, float tex_rotation)
{
	Name = name;
	texColor.set(r,g,b);
...
bool Illuminate::createIlluminate(const string& record)
{
