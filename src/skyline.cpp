...
void SkyLine::setFont(float font_size, const string& font_name)
{
	if (font) delete font;
...
SkyLine_Pole::SkyLine_Pole(SKY_LINE_POLE_TYPE _line_pole_type, double _radius, unsigned int _nb_segment): SkyLine(_radius, _nb_segment)
{
