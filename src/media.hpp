...
public:
	...
	//
	////////////////////////////////////////////////////////////////////////////
	void createVR360(ScriptMgr *_scriptMgr);
	void createViewPort();
	...
	void imageSetLocation(float xpos, bool deltax, float ypos, bool deltay, float duration) {
		imageMgr->setLocation(xpos, deltax, ypos, deltay, duration);
	}
