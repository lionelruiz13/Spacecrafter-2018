...
CoreExecutor::CoreExecutor(Core* _core, Observer* _observer, ScreenFader* _screenFader)
{
	name = "NoDefined";
	core = _core;
	observer = _observer;
 ...
 *
 */
CoreExecutorInSolarSystem::CoreExecutorInSolarSystem(Core* _core, Observer* _observer, ScreenFader* _screenFader) 
							: CoreExecutor(_core, _observer, _screenFader)
{
	name = "InSolarSystem";
	maxAltToGoUp = 1.E16;
}
...
CoreExecutorInGalaxy::CoreExecutorInGalaxy(Core* _core, Observer* _observer, ScreenFader* _screenFader)
						: CoreExecutor(_core, _observer, _screenFader)
{
	name ="InGalaxy";
...
void CoreExecutorInGalaxy::update(int delta_time)
{
	...
	screenFader->fixIntensityUp(maxAltToGoUp/10.0,maxAltToGoUp, observer->getAltitude());
}
...
CoreExecutorInUniverse::CoreExecutorInUniverse(Core* _core, Observer* _observer, ScreenFader* _screenFader)
					:CoreExecutor(_core, _observer, _screenFader)
{
	name ="InUniverse";
	minAltToGoDown = 1.E9;
...
void CoreExecutorInUniverse::update(int delta_time)
{
	...
	screenFader->fixIntensityDown(minAltToGoDown,1.1*minAltToGoDown, observer->getAltitude());
}
