...
void s_font::print(float x, float y, const string& s, Vec4f Color, Mat4f MVP, int upsidedown, int cache)
{
	if(s == "") return;
...
void s_font::printHorizontal(const Projector * prj, float altitude, float azimuth, const string& str, Vec3f& texColor, bool cache, bool outline)
{
	if(str == "") return;
