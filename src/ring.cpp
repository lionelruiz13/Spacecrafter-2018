...
Ring::Ring(double radius_min,double radius_max,const string &texname, /*const string &path,*/ const Vec3i &_init )
...
//~ void Ring::multiplyRadius(float f)
//~ {
	//~ delete lowUP;
	//~ delete lowDOWN;
	//~ delete mediumUP;
	...
	//~ lowUP = new Ring2D((float) radius_min*f, (float) radius_max*f, init[0], 4, true);
	//~ lowDOWN = new Ring2D((float) radius_min*f, (float) radius_max*f, init[0], 4, false);

	//~ mediumUP = new Ring2D((float) radius_min*f, (float) radius_max*f, init[1], 8, true);
	//~ mediumDOWN = new Ring2D((float) radius_min*f, (float) radius_max*f, init[1], 8, false);

	//~ highUP = new Ring2D((float) radius_min*f, (float) radius_max*f, init[2], 16, true);
	//~ highDOWN = new Ring2D((float) radius_min*f, (float) radius_max*f, init[2], 16, false);
//~ }
