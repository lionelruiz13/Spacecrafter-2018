...
protected:
	...
	CoreExecutor(Core *_core, Observer* _observer, ScreenFader* screenFader);
	Core* core;
	Observer* observer;
...
public:
	...
	CoreExecutorInSolarSystem(Core *_core, Observer* _observer, ScreenFader* _screenFader);
...
public:
	...
	virtual void draw(int delta_time) override;
	virtual bool testValidAltitude(double altitude) override;
	CoreExecutorInGalaxy(Core *_core, Observer* _observer, ScreenFader* _screenFader);
...
public:
	...
	virtual void draw(int delta_time) override;
	virtual bool testValidAltitude(double altitude) override;
	CoreExecutorInUniverse(Core *_core, Observer* _observer, ScreenFader* _screenFader);
