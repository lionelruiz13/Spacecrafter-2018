...
public:
	...
	virtual OBJECT_TYPE getType(void) const = 0;

	//! Return object's name
	virtual std::string getEnglishName(void) const = 0;
	virtual std::string getNameI18n(void) const = 0;
	...
	virtual Vec3f getRGB(void) const {
		return Vec3f(1.,1.,1.);
	}
	...
	static void deleteShaderPointeur(void);
	static void deleteShaderStarPointeur(void);
	...
	static void createShaderStarPointeur(void);
	static void createShaderPointeur(void);
